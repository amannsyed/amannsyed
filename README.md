...
| **Resume Matcher** | AI resume analysis app — fit scoring, multi-profile management, UK visa sponsor checking, application tracking, cover letter generation, analytics dashboard | React · TypeScript · Gemini API · Firebase · Recharts | [Live](https://amannsyed.github.io/resume-matcher/) · [Source](https://github.com/amannsyed/resume-matcher) |
